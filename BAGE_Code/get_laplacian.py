# -*- coding:utf-8 -*-
# @Time : 2022/5/22 18:27
# @Author: LCHJ
# @File : get_laplacian.py
...
def get_laplacian(edge_index, num_nodes, edge_weight: Optional[torch.Tensor] = None,
    ...
    esp = torch.ones(num_nodes, device=edge_index.device) * 1e-5
    deg = scatter_add(edge_weight, row, dim=0, dim_size=num_nodes) + esp
